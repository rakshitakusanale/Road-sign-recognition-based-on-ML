    ...
    try:
        ...
        for result in results:
            for box in result.boxes:
                ...
                # Trigger voice output for the detected label and confidence
                label_with_conf = f"{label} with confidence {conf:.2f}"
                engine.say(label_with_conf)  # Speaking the detected label and confidence
